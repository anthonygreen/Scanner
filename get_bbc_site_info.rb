...
scanner.printNewsVpids( "News - Business"           , "http://trevor-producer.api.bbci.co.uk/content/cps/news/business" 	    )
...
scanner.printIplayerVpids( "iPlayer - Somewhat Popular" , "https://ibl.api.bbci.co.uk/ibl/v1/groups/popular/episodes?per_page=20&page=5"                           )
...
scanner.printIplayerChannelVpids( "iPlayer - BBC Radio 1" , "https://ibl.api.bbci.co.uk/ibl/v1/channels/bbc_radio_one/programmes"  )
